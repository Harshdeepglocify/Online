                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="frogot-pass-form">
                    ...
                    <div class="row">
                        <div class="col-xs-4 pull-right">
                            <input type="submit" value="Send Email" name="forgot" class="btn btn-primary btn-block btn-flat"/>
                        </div><!-- /.col -->
                    </div>
                </form>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="pull-right">
                            <a target="_blank" href="https://www.accessibyte.com/terms" class="accessibyte-link">Terms</a> | <a target="_blank" href="https://www.accessibyte.com/privacy" class="accessibyte-link">Privacy</a> | <a target="_blank" href="https://www.accessibyte.com/knowledge-base" class="accessibyte-link">Help</a>
                        </div>
                    </div>
                </div>
