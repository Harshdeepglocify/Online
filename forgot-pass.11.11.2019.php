...
<html>
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (result == 1) {
                            ...
                            $("#errorMessage").html('<div class="alert_box error" aria-live="polite"><button class="close"></button>' + result + ' </div>');
                        }
                    }
                });
            }
    ...
    <body class="hold-transition login-page">
        ...
        <div class="login-box new-Login">
            

            <div class="login-box-body login-header">
                <span class="logo-lg">
          			<div class="image">
              			<img src="<?php echo ADMIN_URL.'/img/logo.png' ?>" class="accessibyte-logo center-block img-responsive" alt="Accessibyte Online Logo" aria-label="Accessibyte Online Logo">
            		</div>
          		</span>
            </div>

            <div class="login-box-body">
                <p class="login-box-msg forgot-pass-msg">Please enter your username (preferred) or email address. You will receive a link to create a new password via email.</p>

                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="frogot-pass-form">
                    <input type="hidden" name="hidden_forgot_pass" value="forgotpass" />
                    <div id="errorMessage" class="help-block help-block-error"></div>
                    <div class="form-group has-feedback ">
						
                        <input type="text" name="username" id="username" autofocus="" required="" class="form-control" placeholder="Username" aria-label="Username field. Enter your username or email here.">
                        <!--<span class="glyphicon glyphicon-envelope form-control-feedback"></span>-->
                    </div>

                    <div class="row">
                        <div class="col-md-12 col-xs-12 pull-right">
                            <input type="submit" value="Reset Password" name="forgot" aria-label="Reset password button" class="btn btn-primary btn-block btn-flat"/>
                        </div><!-- /.col -->
                    </div>
                </form>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="pull-right">
                            <a href="<?php echo ADMIN_URL.'login'; ?>" class="accessibyte-link"><i class="fa fa-long-arrow-left" aria-label="Back to login screen" aria-hidden="true"></i> Back to login</a>
                        </div>
                    </div>
                </div>
