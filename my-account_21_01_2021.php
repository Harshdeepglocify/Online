                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="account-lbl">
                                            ...
                                            <p><input type="hidden" id="licenseid"><span class="hide_encrypt">***************</span><span class="view_encrypt" style="display:none;"><?php echo $users_licenses_details['0']['license']; ?></span>&nbsp;<span class="licenseChk"><label for="checkval" onclick="myFunction()" class="checkid"><i class="fa fa-eye" aria-hidden="true"></i> show<label></span></p>
															<p>
                                                                <?php $no_of_licence = get_license_data($_SESSION['User']['license']);
                                                            ...
                                                            <div class="account-lbl">
                                                                <h3>Expiration :</h3>
                                                                <p><?php
																	if($users_licenses_details['0']['expires'] != 'lifetime' && !empty($users_licenses_details['0']['expires'])){
																		echo date("m-d-Y", strtotime($users_licenses_details['0']['expires'])) . " ";                                                                    
																	}
                                                                ...
                                                                <div class="account-lbl account-btn">
                                                                    <form action="" method="POST" id="update_timezone_frm" class="margin-bottom">
                                                                        ...
                                                                        $timezone_arr =array(
                                                                            ...
                                                                            '(UTC+02:00) Beriut'                              => 'Beriut', 
                                                                            '(UTC+02:00) Cairo'                               => 'Africa/Cairo',
                                                                            '(UTC+02:00) Damascus'                            => 'Asia/Damascus',
                                                                            '(UTC+02:00) E. Europe'                           => 'E. Europe',
                                                                            ...
                                                                            '(UTC+04:00) Port Louis'                          => 'Port Louis', 
                                                                            ...
                                                                            '(UTC+10:00) Canberra, Melbourne, Sydney'         => 'Australia/Sydne',
                                                                            ...
                                                                            '(UTC+14.00) Kiritimati Island'                   => 'Kiritimati Island'  
                                                                    );
                                                                     ?>
                                                                        <p>
