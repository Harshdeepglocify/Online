...
if( isset( $_POST ) ){
    if( isset( $_POST['forgot'] ) && $_POST['forgot'] == 'RESET PASSWORD' ){
    ...
    <body class="hold-transition login-page">
        ...
        <div class="login-box new-Login">
            ...
            <div class="login-box-body">
                <p class="login-box-msg forgot-pass-msg">Please enter your username or email address.you will receive a link to create a new password via email.</p>
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="frogot-pass-form">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-12 pull-right">
                            <input type="submit" value="RESET PASSWORD" name="forgot" class="btn btn-primary btn-block btn-flat"/>
                        </div><!-- /.col -->
                    </div>
                </form>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="pull-right">
                            <a href="<?php echo ADMIN_URL.'login'; ?>" class="accessibyte-link"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Back to Login</a>
                        </div>
                    </div>
                </div>
