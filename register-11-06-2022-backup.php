                ...
                <div class="register_header">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-xs-12 form-group input_box no-padding">
                            <a class="btn btn-primary btn-block btn-flat btn-accessibyte" href="javascript:void(0)" id="user_type_student" type="button" aria-label="Home User Registration Button">Home User</a>
