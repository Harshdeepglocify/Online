                                ...
                                if (!empty($no_of_licence) && isset($no_of_licence['no_student_use'])) {
                                    ...
                                    if(!$is_expired){
                                        ...
                                        <div class="new-option-section-wrap" style="display: none;">
                                            <ul class="new-option">
                                                <li><a href="javascript:void(0);" class="student-import-csv" >Import CSV</a></li>
                                                <li><a href="javascript:void(0);" class="student-export-to-csv" data-id="student-admin-list">Export CSV</a></li>                                                
                                                <li><a href="<?php echo ADMIN_URL . "student/export_student_data_pdf.php";?>" class="student-export-to-pdf" >Export PDF</a></li>                                                                                                
                                            </ul>
                                        </div>
                                        <?php
                                    }
                                ...
                                <!-- START : PUT Download Option  ON 02-09-2021 ADDED BY PHP DEV 3 -->
                                  ...
                                  <!-- END : PUT Download Option  ON 02-09-2021 ADDED BY PHP DEV 3 -->
                                    ...
                                    <div class='student-add-column'>
                                        ...
                                        <div class="new-option-section-wrap" style="display: none;">
                                            <ul class="new-option">
                                                <li><a href="javascript:void(0);" class="student-export-histoy-to-csv" >Export Typio History CSV</a></li>                                                                                                
                                            </ul>
                                        </div>
                                    </div>
