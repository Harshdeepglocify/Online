                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="box-body students_test_tbl">
												...
												<div class="new-option-section">
                                                    <button type="button" style="margin-top:15px;" class="dashboard-settings-btn btn-block" data-toggle="modal" data-target="#add-students-test-modal" >Create New Test</button>
                                                    <button class="new-option-btn" id="new-option-btn-test">
                                                        <i class="fa fa-chevron-down"></i>
                                                    </button>
                                                </div>
                                                <div class="new-option-section-wrap" style="display:none;" id="new-option-section-wrap-test">
                                                        <ul class="new-option">
                                                          ...
                                                          <!--  <li>
                                                                <button type="button" class="dashboard-settings-btn btn-block deck-csv-import-modal-test" data-toggle="modal" data-target="#typio-import-csv_modal-test">Import Test from CSV</button>
                                                            </li>-->
                                                        </ul>
                                                </div>	
            ...
            <div class="modal fade" id="typio-import-csv_modal-test" aria-hidden="false" style="display: none;">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <div class="col-md-12">
                                <button type="button" class="dashboard-settings-btn btn-block" name="import_csv_typio_test" id="import_csv_typio_test">Save Test</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-footer" style="margin-top: 20px">
                            ...
                            <div id="edit_deck_footer">
                                ...
                                <div class="" style="margin-bottom: 10px">
                                    ...
                                    <button type="button" class="dashboard-settings-btn btn-block " id="add-more-side_fields_edit">Add Card to Deck</button>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="col-md-12 test-cls">
                                <div class="new-option-section">
                                                    <button type="button" class="dashboard-settings-btn btn-block edit-students-test-save">Save Test</button>
                                ...
                                <div class="new-option-section-wrap" style="display:none;" id="new-option-section-wrap-edit-test">
                                                        <ul class="new-option">
                                                            <li>
                                                               <button type="button" class="dashboard-settings-btn btn-block deck-test-export-modal ">Export Test</button>
                                                            </li>                               
                                                        </ul>
                                   </div>
                            </div>
