                    ...
                    <div class="row">
                        ...
                        if ($_SESSION['User']['id'] == 63 || $_SESSION['User']['id'] == 77) {          // user-id = 63 is Joe Teacher, user-id = 77 is Demo Teacher
                            ...
                            <div class="col-lg-12" style="margin-bottom:10px;">
                                <input type="button" class="btn btn-info" id="sync_lic" value="Sync Licenses" />
  ...
  <span> <a href="' . ADMIN_URL . 'student/student-overview.php?student=' . $user['id'] . '" aria-label="Overview for ' . ucfirst(base64_decode($user['firstname'])) .' " class="accessibyte-link">Overview</a>
    ...
    <a href="' . ADMIN_URL . 'student/student-password.php?student=' . $user['id'] . '" class="accessibyte-link" aria-label="Change Password for ' . ucfirst(base64_decode($user['firstname'])) .' ">Change Password</a></span>';
      ...
      <a href="javascript:void(0)" data-id="' . $user['id'] . '" data-name="' . ucfirst(base64_decode($user['firstname'])) . '(' . $user['username'] . ')" class="accessibyte-link delete_student" aria-label="Delete ' . ucfirst(base64_decode($user['firstname'])) .' ">Delete</a>
                                                ...
                                                echo '<tr><td>You have no students</td></tr>';
                                            }
                                            ?>                    
                                        </tbody>
                                    </table>
                        ...
                        <div class="col-lg-12">
							<div class="box-body panel student-title-main-init student-add-custom">              
								<div class="col-md-2">
								<h3><a href="<?php echo ADMIN_URL . "student/add-new-student.php"; ?>" class="dashboard-settings-btn btn-block"><i class="fa fa-plus"></i>Add Student</a></h3>
								</div>
								<?php 
								...
								$used = $totle - $left;
								?>
								<div class="col-md-3"><h4 class='student-custimize-text'>Seats in use :  <?php echo $used.' of '.$totle;?></h4></div>
								<div class="col-md-3"><h4 class='student-custimize-text'>Seats available : <?php echo $left;?></h4></div>
								<?php }?>
							</div>
...
//                                                        echo $usrename;
                        ...
                        <div class="col-lg-12">
                            <button  class="btn btn-info" id="newlicense_popup" data-toggle="modal" data-target="#add-new-license-modal" >Assign License</button>
                        </div>
                    </div>
                </section>  
            </div>
                ...
                <div class="modal-content">
                    ...
                    <form id="active-license-form" name="active-license-form" method="POST">
                        ...
                        <div class="modal-footer">
                            <button type="submit" name="ActiveLicenseSubmit" class="btn btn-primary edit-lessons-btn">Add License</button>
                        </div>
                    </form>
                </div>
                <!-- /.modal-content -->
