                                    ...
                                    <table id="student_list_table" class="student_custom_list_table table table-bordered wt-student-list-table-cs wt-student-list-tableheader-cs" border="2">
                                        <thead>
                                            <tr>
                                                ...
                                                <td><h4 class="Students-title-cs"><input type="checkbox" id="select_all_students"><b>Nickname </b></h4></td>
                                                <td><h4 class="Students-title-cs"><b>Username</b></h4></td>
                                                <td><h4 class="Students-title-cs"><b>Last Active</b></h4></td>
                                                <!-- <td><h4 class="Students-title-cs"><b>Activity</b></h4></td>-->
                                                <?php if(!$is_expired){?>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="box-body panel student-title-main-init student-add-custom">
                                ...
                                $no_of_licence = get_license_data($_SESSION['User']['license']);
                                 ...
                                 //echo "<pre>";print_r($no_of_licence);
                                if (!empty($no_of_licence) && isset($no_of_licence['no_student_use'])) {
                                    echo "<div class='student-add-column'><div class='student-add-column-list student-student-list'>";
                                    if(!$is_expired){
                                        if ($no_of_licence['no_student_use'] != $no_of_licence['no_student']) {
                                            ?>
                                            <div class="new-option-section">
                                                <button type="button" class="dashboard-settings-btn btn-block" onclick="window.location.href='<?php echo ADMIN_URL . 'student/add-new-student.php'; ?>'">
                                                    <i class="fa fa-plus"></i> Add Student
                                                </button>
                                                <!--<a href="<?php //echo ADMIN_URL . "student/add-new-student.php"; ?>" class="dashboard-settings-btn btn-block"><i class="fa fa-plus"></i>Add Student</a>-->
                                                <button class="new-option-btn" aria-label="add students more options">
                                        ...
                                        <div class="new-option-section-wrap" style="display: none;">
                                            <ul class="new-option">
                                                <li> 
                                                    <button type="button" class="student-export-to-csv">
                                                        Export CSV
                                                    </button>
                                                    <!--<a href="javascript:;" class="student-export-to-csv">Export CSV</a>-->
                                                </li> 
                                                <li>
                                                     <!--<button type="button" class="student-export-to-pdf" onclick="window.location.href='<?php echo ADMIN_URL . 'student/export_student_data_singleteacher_pdf.php'; ?>'">
                                                        Export PDF
                                                    </button>-->
                                                    <!--<a href="<?php //echo ADMIN_URL . "student/export_student_data_singleteacher_pdf.php";?>" class="student-export-to-pdf" >Export PDF</a>-->
                                                </li>                                                                                                        
                                            </ul>
                                        </div>
                                        <?php
                                    ...
                                    <div class='student-add-column'>
                                        <div class="new-option-section">
                                              <!--<a href="<?php echo ADMIN_URL;?>student/student-reports.php" class="dashboard-settings-btn btn-block student-exported-data-link">Exported Data</a>-->
                                                <button type="button" class="dashboard-settings-btn btn-block student-export-histoy-to-csv">
                                                   Export Typio Data
                                                </button>
                                                <!--<a href="javascript:void(0);" class="student-export-histoy-to-csv" >Export Typio History CSV</a>-->
												
                                                <button class="new-option-btn"  aria-label="export typio history CSV more options">
                                                    <i class="fa fa-chevron-down"></i>
                                                </button>
                                        ...
                                        <div class="new-option-section-wrap" style="display: none;">
                                            <ul class="new-option">
												...
												<?php $licenseuser = $_SESSION['User']['license'];
												
												if (strpos($licenseuser, 'TCHP') !== false) {
														
												?>
												<button type="button" class="student-export-braillio-csv">
                                                        <i class="fa fa-download"></i> Export Braillio Data
                                                    </button>
													<button type="button" class="student-export-quickcards-csv">
                                                        <i class="fa fa-download"></i> Export Quick Cards Data
                                                    </button>
													<?php 
												} else {
												...
												?>
													<button type="button" class="student-export-activitydata-csv">
                                                        <i class="fa fa-download"></i> Export Activity Data
                                                    </button>
                                                    <!--<button type="button" class=" student-export-data-pdf">
                                                        <i class="fa fa-download"></i> Download Data
                                                    </button>-->
                                                    <!--<a href="javascript:void(0);" class="dashboard-settings-btn btn-block student-export-data-pdf"><i class="fa fa-download"></i>Download Data</a>-->
                                                </li>                                                                                                
                                            </ul>
                                        </div>
                                    </div>
                                    <div class='student-add-column-two'>
                                        ...
                                        <?php
                                            ...
                                            <button type="button" class="dashboard-settings-btn btn-block delete-all-button">
                                                <i class="fa fa-trash"></i> Delete All Data Now
                                            </button>
                                            <!--<a href="javascript:void(0);" class="dashboard-settings-btn btn-block delete-all-button"><i class="fa fa-trash"></i>Delete All Data Now</a>-->
                                            <?php
                                            /* START : Put Delete All Student Functionality Added BY PHP DEV 6 ON 06-09-2021*/
                                    ...
                                    if (!empty($licenseArr)) {
                                        ...
                                        $used = $totle - $left;
                                        ?>
                                        <div class="student-add-column-icons"><h4 class='student-custimize-text'>Student seats in use:<span><?php echo $used . ' / ' . $totle; ?></span></h4></div>
                                    <?php
                                    }
                                }
                                ?>
								...
								<div class="student-add-column-cst-msg"></div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <form id="delete-student-form" name="delete-student-form" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <p class='warning-text'>All data for those students will be deleted. This cannot be undone.</p>
        ...
        $(document).ready(function() {           
            ...
            var table = $('#student_list_table').DataTable({
                ...
                "ajax": {
                    ...
                    "type": "POST",
                    data: {'action': 'ajax_student_list','is_ajax' : '1'},
                },
                "order": [[0, 'DESC']],
                "columnDefs": [
                    {"targets": 0, "name": "firstname", 'searchable': true, 'orderable': true},
                    {"targets": 1, "name": "username", 'searchable': true, 'orderable': true},
                    {"targets": 2, "name": "login", 'searchable': false, 'orderable': true,'className': 'target-column-2'},
            ...
            $(document).on('click', '.delete-href', function (event) {
                ...
                if (records_to_del.length == 0) {
                    //alert('Please check the box next to at least one student in the list.');
                    alert('Please select a student.');
                } else {
                    $('.studentList').html(newstr);
                    $('.delete_multi_student_text').val('');
                ...
                if (records_to_del.length == 0) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
							...
							if (data.Success == "200" || data.Success == "409") {
						
								$('.student-add-column-cst-msg').html(data.msg);
								$('#student_rpt_mnu').removeClass('history_hide ');
								$('#list_lnk_mystu').removeClass('history_hide ');
							} else {
								  $('.student-add-column-cst-msg').html(data.msg);
                           ...
                           /* var downloadLink = document.createElement("a");
                            ...
                            downloadLink.download = "Accessibyte Typio History.csv";
			...
			$(document).on('click', '.student-export-braillio-csv', function (event) {
                var records_to_del = [];
                var str = '';
                $("input[name='ids[]']:checked").each(function () {
                    records_to_del.push($(this).val());
                ...
                if (records_to_del.length == 0) {
                    ...
                    //$(this).attr('href',ADMIN_URL + 'student/export_student_history_csv_data.php');
                    $.ajax({
                        url: ADMIN_URL + 'student/export_student_braillio_csv_data.php',
                        type: "post",
                        method:"POST",
                        data:{ids : records_to_del},
                        success: function(data) {
                           ...
                           /* var downloadLink = document.createElement("a");
                            ...
                            var url = URL.createObjectURL(blobObject);
                            downloadLink.href = url;
                            downloadLink.download = "Accessibyte Braillio History.csv";
			...
			$(document).on('click', '.student-export-quickcards-csv', function (event) {
                var records_to_del = [];
                var str = '';
                $("input[name='ids[]']:checked").each(function () {
                    records_to_del.push($(this).val());
                ...
                if (records_to_del.length == 0) {
                   // alert('Please select any one row!');
                    ...
                    //$(this).attr('href',ADMIN_URL + 'student/export_student_history_csv_data.php');
                    $.ajax({
                        url: ADMIN_URL + 'student/export_student_quickcards_csv_data.php',
                        type: "post",
                        method:"POST",
                        data:{ids : records_to_del},
                        success: function(data) {
						...
						if (data.Success == "200" || data.Success == "409") {
                            ...
                            */
                            ...
                            var url = URL.createObjectURL(blobObject);
                            downloadLink.href = url;
                            downloadLink.download = "Accessibyte Quick Cards History.csv";
			...
			$(document).on('click', '.student-export-activitydata-csv', function (event) {
                var records_to_del = [];
                var str = '';
                $("input[name='ids[]']:checked").each(function () {
                    records_to_del.push($(this).val());
                ...
                if (records_to_del.length == 0) {
                   // alert('Please select any one row!');
                    ...
                    //$(this).attr('href',ADMIN_URL + 'student/export_student_history_csv_data.php');
                    $.ajax({
                        url: ADMIN_URL + 'student/export_student_overviewol_csv_data.php',
                        type: "post",
                        method:"POST",
                        data:{ids : records_to_del},
                        success: function(data) {
                            ...
                            */
                            ...
                            var url = URL.createObjectURL(blobObject);
                            downloadLink.href = url;
                            downloadLink.download = "Accessibyte Activity History.csv";
			...
			$('#select_all_students').on('click', function(e) {
			...
			$('.chkbox').on('click', function(e) {
				...
				$('#select_all_students').prop(
					'checked',
					$('.chkbox:checked').length === $('.chkbox').length
				);
			});
		});
