                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="chart-one-main-init">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="hangman_msg"> 
                                            ...
                                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#add-hangman-modal"  >Add New</button>
                                            <!-- /.box-header -->
                                    ...
                                    <div class="col-md-offset-1 col-md-3">
                                        <div class="">
                                            <div class="with-border">
                                                <h3 class="box-title">Share With</h3>
                                            </div>
                                            <div class="">
                                                <!-- form -->
                                                <form role="form">
                                                    <div class="form-group">
                                                        ...
                                                        <select multiple="" name="share_user_list" class="form-control hangman_share_user_list">
                                                            <?php
                                                            if (!empty($student_data)) {
                                                                foreach ($student_data as $key => $value) {
                                                                    echo '<option value="' . $value['id'] . '">' . base64_decode($value['firstname']) . ' ' . base64_decode($value['lastname']) . '</option>';
                                                                }
                                                            }
                                                            ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group action-btn-chart-init">
                                                        <button type="button" class="btn btn-info hangman-share-submit">Share</button>
                                                    </div>
                                                </form> 
                                                <!-- End form -->                             
                                            </div>
                                ...
                                <div class="row">
                                    <div class="crazy-sidebar-alert alert alert-dismissible"></div>
                                    <!--<div class="col-md-12">
                                        <div class="with-border">
                                            <h3 class="box-title">Arcade - Crazy Phrase</h3>
                                        </div>
                                    </div>-->
                                    <?php
                                    ...
                                    function getsectionThreeData() {
                                        ...
                                        $table = 'text';
                                        $query = query("SELECT * FROM text WHERE text.app='Arcade-OL' AND text.number=1 AND id='" . $user_id . "'");
                                        while ($row = mysqli_fetch_array($query)) {
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if (isset($gameData) && !empty($gameData)) {
                                                            ...
                                                            foreach ($gameData as $k => $v) {
                                                                ?>
                                                                <tr>
                                                                    <td><input type="checkbox" name="share_crazy_ids[]" value="<?php echo $value['table_id']; ?>" class="share_crazy_ids"></td>
                                                                    <td><?php echo $v['title'] ?></td>
                                                                    <td>
                                                                        <a href="javascript:void(0)" class="badge bg-green game-data-edit" data-id="<?php echo $v['table_id'] ?>">
                                                                            <i class="fa  fa-edit"></i>
                                                                        </a>
                                                                    </td>
                                                                    <td>
                                                                        <a href="javascript:void(0)" class="badge bg-red game-data-delete" data-id="<?php echo $v['table_id'] ?>">
                                                                            <i class="fa fa-trash-o" aria-label="Delete"></i>
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="">
                                                ...
                                                <form role="form">
                                                    <div class="form-group">
                                                        <label>Students</label>
                                                        <select multiple="" class="form-control crazy_share_user_list">
                                                            <?php
                                                            if (!empty($student_data)) {
                                                                foreach ($student_data as $key => $value) {
                                                                    echo '<option value="' . $value['id'] . '">' . base64_decode($value['firstname']) . ' ' . base64_decode($value['lastname']) . '</option>';
                                                    ...
                                                    <div class="form-group action-btn-chart-init">
                                                        <button type="button" class="btn btn-info crazy-share-submit">Share</button>
                                                    </div>
                                                </form> 
                                                <!-- End form -->                             
                                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" id="add-hangman-form">
                            ...
                            <div id="append"></div>
                            <button type="button" class="btn btn-primary" id="add-more-fields">Add New</button>
                        </form>
                    </div>
