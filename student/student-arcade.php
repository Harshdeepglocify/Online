...
$arcade_history_from = getTimezonewiseDate($arcade_history_from);
$arcade_history_to = getTimezonewiseDate($arcade_history_to);
?>
<!--   Arcade Section one   --> 
...
<div class="row" id="ArcadeHistoryDateSection">
    ...
    <div class="form-group col-md-2 col-xs-12">
       ...
       <div class="btn-group">
            ...
            <!--<input type="submit" name="ArcadeHistoryDateSubmit" value="Show history" id="ArcadeDateFilterBtn" class="dashboard-settings-btn btn-block" aria-label="Show Hisotry button">-->

            <input type="submit" name="ArcadeHistoryDateSubmit" value="Show history" id="ArcadeDateFilterBtn_new" class="dashboard-settings-btn btn-block" onclick="display_arcade_history_data();"  aria-label="Show Hisotry button">
	       ...
	       <!-- <div class="box-body table-responsive no-padding">
            ...
            -->
             ...
             <div class="table-responsive">
                        <table id="student_arcade_history_list_table" class="student_custom_list_table table table-bordered wt-student-list-table-cs wt-student-list-tableheader-cs table-list-custom" border="2">
                            <thead>
                                <tr>
...
<div class="row">
    <div class="col-md-6">
        <div class="hangman_msg">
            ...
            <!-- /.box-header -->
          <?php /*  <div class="box-body hangman-table">
            ...
            */?>
            <div class="table-responsive">
                    <table id="student_arcade_hangman_list_table" class="student_custom_list_table table table-bordered wt-student-list-table-cs wt-student-list-tableheader-cs table-list-custom" border="2">
                                <thead>
                                    <tr>
                                        <td><h4 class="Students-title-cs"><b>Task</b></h4></td>
             ...
             <div class="new-option-section">
                <button type="button" style="" class="dashboard-settings-btn btn-block" data-toggle="modal" data-target="#add-hangman-modal" aria-label="Create new hangman lesson button">Create new hangman lesson</button> 

                <button class="new-option-btn-dashboard new-option-btn" aria-label="Create hangman lesson more options">
            ...
            <div class="new-option-section-wrap" style="display:none;">
                    <ul class="new-option">
                        <li>
                        <button type="button" class="dashboard-settings-btn btn-block hangman-import-modal " data-toggle="modal" data-target="#hangman-import-modal">Import Hangman Lesson</button>
                        </li>                               
                    </ul>
            </div>
...
$arcade_voice_options = array(
    'Off' => 'Off',
    'Default' =>"Default"
   // 'Google US English' => 'US English', 'Google UK English' => 'UK English'
);
        ...
        <div class="col-md-12">
            <div class="form-group col-md-4">
                ...
                <select class="form-control" name="arcade_voice">
                    ...
                    <?php } ?>
                    <?php
                     if(!empty($db_arcade_voice) && $db_arcade_voice !="Off" && $db_arcade_voice !="Default") { ?>
                        <option value="<?php echo $db_arcade_voice; ?>" selected><?php echo $db_arcade_voice; ?></option>
                   <?php } ?>
                </select>
            </div>
        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="form-group">
                <div class="comman-button-input-option-wrap">
                    ...
                    <input type="submit" name="ArcadeSettingSubmit" aria-label="Save arcade setting button"  data-for="single" value="Save" id="ArcadeSettingSubmitBtn" class="dashboard-settings-btn btn-block">
                    <span name="common_option" class="common-option-btn" aria-label="Save arcade settings more options" aria-role="button">
                            <i class="fa fa-chevron-down"></i>
                        </span>
                </div>
                <div class="common-option-section-wrap" style="display: none;">
                    <ul class="new-option">
                        <li><input type="submit" class='arcade-settings-submit all-student-settings' data-for="all" name="ArcadeSettingSubmit" value="Save Arcade Settings For All Students" id="arcade-settings-submit-all" aria-label="Save arcade settings for all student" class="dashboard-settings-btn btn-block" ></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="add-hangman-form">
                    ...
                    <div id="append"></div>
                    <button type="button" class="dashboard-settings-btn btn-block" id="add-more-fields">Add New Word</button>
                </form>
            </div>
...
<script src="<?php echo ADMIN_URL ?>plugins/jQuery/jQuery-2.1.4.min.js"></script>  
    <script>
            $(document).ready(function() {
                $('#arcadeTab').click(function() {
                    if($('#arcade').attr('data-load') !== undefined) {
                        var table = $('#student_arcade_hangman_list_table').DataTable({
                            ...
                            "ajax": {
                                ...
                                "type": "POST",
                                data: {'action': 'ajax_student_hangman_lesson','is_ajax' : '1','student_id':"<?php echo $_GET['student'];?>"},
                            },
                            "order": [[0, 'ASC']],
                            "columnDefs": [
                        ...
                        //  var ArcadeDatePickerFrom = $('#ArcadeHistoryDateSection #ArcadeDatePickerFrom').val();
                        //var ArcadeDatePickerTo = $('#ArcadeHistoryDateSection #ArcadeDatePickerTo').val();
                        ...
                        var table = $('#student_arcade_history_list_table').DataTable({
                            ...
                            "ajax": {
                                "url": "<?php echo ADMIN_URL; ?>config/config-student.php",
                                "type": "POST",
                                data: {'action': 'ajax_student_arcade_history','is_ajax' : '1','student_id':"<?php echo $_GET['student'];?>",'ArcadeDatePickerFrom':ArcadeDatePickerFrom,'ArcadeDatePickerTo':ArcadeDatePickerTo},
                            },
                            "order": [[0, 'DESC']],
                            "columnDefs": [
