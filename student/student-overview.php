...
if(isset ($_SESSION['ArcadeDatePickerFrom'])){
    unset ($_SESSION['ArcadeDatePickerFrom']);
 }
 if(isset ($_SESSION['ArcadeDatePickerTo'])){
    unset ($_SESSION['ArcadeDatePickerTo']);
 }
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
				...
				if ((is_user_belong_to_teacher($_GET['student'], $teacher_code)) || (isset($_SESSION['User']['is_admin']) && !empty($_SESSION['User']['is_admin']))) {
                    ?>                
                    <!-- Main content -->
                                    ...
                                    <div class="nav-tabs-custom">
                                        <ul class="nav nav-tabs">
											...
											if(!empty($expload_license_check)){
												if (!empty($TYO_license['status']) && ($expload_license_check[0] == 'BDL' || $expload_license_check[0] == 'TCHP' || $expload_license_check[0] == 'TCHI' || $expload_license_check[0] == 'TCH' || $expload_license_check[0] == 'TYO') && ( $TYO_license['status'] == "inactive" || $TYO_license['status'] == "active" || $TYO_license['status'] == "expired" || $TYO_license['status'] == "expires" )) {
										...
										if (!empty($PRO_license['status']) && ($expload_license_check[0] == 'BDL' || $expload_license_check[0] == 'TCHP') && ( $PRO_license['status'] == "inactive" || $PRO_license['status'] == "active" || $PRO_license['status'] == "expired" || $TYO_license['status'] == "expires" ) || $ty_options_value[150] == 1) {
													echo '<li class=""><a id="Braillio-Tab" href="#Braillio" data-toggle="tab" aria-expanded="false">Braillio</a></li>';
												}
											}
                                            ?>                                        
                                        </ul>
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="overview">
                                                ...
                                                <div class="row overview-graph-total dev_overview">
                                                ...
                                                //if(!empty($is_data)){
                                                    ...
                                                    <div class="col-md-6 lessons_chart_print <?php  echo $clss_overview_a_history; ?>" > 
                                                        <div id="overview_graph_minhrs"></div>
                                                        <div class="chart chart-p-typio-init tr" <?php echo $chart; ?>> 
                                                    ...
                                                    <form method="post" class="custom-p-form-init"> 
                                                        ...
                                                        <div class="form-group col-md-7 col-xs-12"> 
                                                            ...
                                                            <div class="btn-group col-md-2">  
															  ...
															  <div class="custom-p-form-init-child custom-overview col-md-10">
        
		
																	<div class="">
																	<div class="btn-group">
																	  
																	   <input type="hidden" value="<?php echo date('m/d/Y', strtotime($today_date ));?>" id="OverviewTodayFilterstart">
																	   <input type="hidden" value="<?php echo date('m/d/Y', strtotime($typio_history_end_date)); ?>" id="OverviewTodayFilterend">
																	   <input type="button" name="OverviewTodaySubmit" value="Today" id="OverviewTodayFilterBtn" class="dashboard-settings-btn btn-block" aria-label="Show Today button">
																	</div>

															   </div>
																<div class="">
																	<div class="btn-group">
																	   <input type="hidden" value="<?php echo $typio_history_submit_check; ?>" id="OverviewHistoryDateSubmitCheck1">
																	   <input type="hidden" value="<?php echo date('m/d/Y', strtotime($typio_history_start_date));?>" id="OverviewThisWeekFilterstart">
																	   <input type="hidden" value="<?php echo date('m/d/Y', strtotime($typio_history_end_date)); ?>" id="OverviewThisWeekFilterend">
																	   <input type="button" name="OverviewThisWeekSubmit" value="This Week" id="OverviewThisWeekFilterBtn" class="dashboard-settings-btn btn-block OverviewActiveBtn" aria-label="Show This Week button">
																	</div>
															   ...
															   <div class="">
																	<div class="btn-group">
																	   <input type="hidden" value="<?php echo date('m/d/Y', strtotime($typio_month_start_date ));?>" id="OverviewThisMonthFilterstart">
																	   <input type="hidden" value="<?php echo date('m/d/Y', strtotime($typio_history_end_date)); ?>" id="OverviewThisMonthFilterend">
																	   <input type="button" name="OverviewThisMonthSubmit" value="This Month" id="OverviewThisMonthFilterBtn" class="dashboard-settings-btn btn-block" aria-label="Show This Month button">
																	</div>
															   </div>
															   
															   <div class="">
																	<div class="btn-group">
																	   <input type="hidden" value="<?php echo date('m/d/Y', strtotime($typio_year_start_date));?>" id="OverviewThisYearFilterstart">
																	   <input type="hidden" value="<?php echo date('m/d/Y', strtotime($typio_history_end_date)); ?>" id="OverviewThisYearFilterend">
																	   <input type="button" name="OverviewThisYearSubmit" value="This Year" id="OverviewThisYearFilterBtn" class="dashboard-settings-btn btn-block" aria-label="Show This Year button">
																	</div>
															   ...
															   <div class="">
																	<div class="btn-group">
																	   <input type="hidden" value="<?php echo date('m/d/Y', strtotime($alltimestartdate));?>" id="OverviewAllTimeFilterstart">
																	   <input type="hidden" value="<?php echo date('m/d/Y', strtotime($typio_history_end_date)); ?>" id="OverviewAllTimeFilterend">
																	   <input type="button" name="OverviewAllTimeSubmit" value="All Time" id="OverviewAllTimeFilterBtn" class="dashboard-settings-btn btn-block" aria-label="Show All Time button">
																	</div>
															   </div>
                                                ...
                                                <div class="row" id="HistorySection">  
                                                    ...
                                                    <div class="col-md-6 lessons_chart_print <?php echo $clss_history; ?>"> 
                                                        <div class="row overview-history-graph-total">
                                                            <!--<div class="col-md-4">-->
                                                                <center><h3><span class="row overview-history-graph-total-time"><?php echo getUserActivityLog_graph($student_id,'',$history_start_date,$history_end_date,'');?></span></h3></center>
                                                            <!--</div>-->
                                                        </div>
                                            ...
                                            <?php
                                            if (!empty($TYO_license['status']) && ($expload_license_check[0] == 'BDL'  || $expload_license_check[0] == 'TCHI'  || $expload_license_check[0] == 'TCHP' || $expload_license_check[0] == 'TCH' || $expload_license_check[0] == 'TYO') && ( $TYO_license['status'] == "inactive" || $TYO_license['status'] == "active" || $TYO_license['status'] == "expired" || $TYO_license['status'] == "expires" )) {
												
                                                ?>
                                                <!-- ---------- Typio Sectoin ---------- --> 
                                                <div class="tab-pane" id="typio" data-load="initial">
                                            ...
                                            if (!empty($PRO_license['status']) && ($expload_license_check[0] == 'BDL' || $expload_license_check[0] == 'TCHP') && ( $PRO_license['status'] == "inactive" || $PRO_license['status'] == "active" || $PRO_license['status'] == "expired" || $TYO_license['status'] == "expires" )) {
                                                ?>
                                                <!-- ---------- Quick cards ---------- --> 
                                                <div class="tab-pane" id="quick_cards" data-load="initial">
                                            ...
                                            if (!empty($expload_license_check) && ($expload_license_check[0] == 'BDL' || $expload_license_check[0] == 'TCHP')) { ?>
                                                ...
                                                <div class="tab-pane" id="arcade" data-load="initial">
											...
											if (!empty($PRO_license['status']) && ($expload_license_check[0] == 'BDL' || $expload_license_check[0] == 'TCHP') && ( $PRO_license['status'] == "inactive" || $PRO_license['status'] == "active" || $PRO_license['status'] == "expired" || $TYO_license['status'] == "expires" )) {
												?>
												<div class="tab-pane" id="propack" data-load="initial">
...
<?php                                
            if (!empty($PRO_license['status']) && ($expload_license_check[0] == 'BDL' || $expload_license_check[0] == 'TCHP') && ( $PRO_license['status'] == "inactive" || $PRO_license['status'] == "active" || $PRO_license['status'] == "expired" || $TYO_license['status'] == "expires" )) {
												?>
												<div class="tab-pane" id="Braillio" data-load="initial">
													<?php include 'student-Braillio.php'; ?>
												</div>
											<?php
											}
											?>
