                    ...
                    <div class="row">
                                    ...
                                    <table id="admin_student_list_table" class="student_custom_list_table table table-bordered wt-student-list-table-cs wt-student-list-tableheader-cs" border="2">
                                        <thead>
                                            <tr>
                                                ...
                                                <td><h4 class="Students-title-cs"><input type="checkbox" id="select_admin_all_students"><b>Nickname</b></h4></td>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="box-body panel student-title-main-init student-add-custom">
                                    ...
                                    <div class='student-add-column'>
                                        <div class="new-option-section">
                                                <button type="button" class="dashboard-settings-btn btn-block student-export-histoy-to-csv">
                                                    <i class="fa fa-download"></i> Export Typio Data
                                                </button>
                                        ...
                                        <div class="new-option-section-wrap" style="display: none;">
											...
											<?php $licenseuser = $_SESSION['User']['license'];
												...
												?>
                                                <li>
                                                    <button type="button" class="student-export-braillio-to-csv GallData">
                                                        Export Braillio Data
                                                    </button>
                                                </li>
												<li>
                                                    <button type="button" class="student-export-quickcards-to-csv GallData">
                                                        Export Quick Cards Data
                                                    </button>
                                                </li>
												<?php }?>
												<li>
                                                    <button type="button" class="student-export-activity-to-csv GallData">
								...
								<div class="student-add-column-cst-msg">
								</div>
                            </div>
...
<?php include "../config/setting.php"; ?>
                    ...
                    <form id="add-student-form" name="add-student-form" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text" name="firstname" id="firstname" autofocus="" required="" class="form-control firstname" placeholder="Display Name">
                                <span class='nickname commonerror'></span>
                                <span class='nickname commonerror1'>For your reference. Don't use real names or PII</span>
                            </div>

                            <div class="form-group ">
                                <label>Username *</label>
                                <input type="text" name="username" id="username" required="" class="form-control uname" placeholder="Username" oninput="text_restrictions(this);">
    ...
    type: 'POST',
    data: { action: 'ajax_admin_student_list', is_ajax: '1', client_side: '1' },
    dataSrc: 'data'          // fetch the full data array
  },
                    "paging": true,
		            "lengthMenu": [25, 50, 100, 300], // Set pagination options (5, 10, 25, 50 records per page) Added by Joe 18-10-2024
                    "pageLength": 300,
                    "lengthChange": true,
                    "order": [[0, 'DESC']],
                    "columnDefs": [
                        ...
                        {"targets": 4, "name": "login", 'searchable': false, 'orderable': true,'className': 'target-column-4'},
                        <?php if(!$is_expired) { ?>
               ...
               $(document).on('click', '.student-export-histoy-to-csv', function (event) {
                    ...
                    $.ajax({
                        ...
                        url: ADMIN_URL + 'student/export_student_history_csv_data_license.php',
                        type: "post",
                        method:"POST",
                        data:{ ids : records_to_export, stuadm:'1' },
				...
				$(document).on('click', '.student-export-braillio-to-csv', function (event) {
                    var records_to_export = [];
                    var str = ''; 
                   ...
                   // }
                    ...
                    //$(this).attr('href',ADMIN_URL + 'student/export_student_history_csv_data.php');
                    $.ajax({
                        url: ADMIN_URL + 'student/export_student_admin_braillio_csv_data_license.php',
                        type: "post",
                        method:"POST",
				...
				$(document).on('click', '.student-export-quickcards-to-csv', function (event) {
                    var records_to_export = [];
                    var str = ''; 
                   ...
                   // }
                    ...
                    //$(this).attr('href',ADMIN_URL + 'student/export_student_history_csv_data.php');
                    $.ajax({
                        //url: ADMIN_URL + 'student/export_student_admin_quickcards_csv_data.php',
                        url: ADMIN_URL + 'student/export_student_admin_quickcards_csv_data_license.php',
                        type: "post",
                        method:"POST",
                        data:{ ids : records_to_export },
                        success: function(data) {
				...
				$(document).on('click', '.student-export-activity-to-csv', function (event) {
                    var records_to_export = [];
                    var str = ''; 
                   ...
                   // }
                    $('#spinner_loader').show();
                    //$(this).attr('href',ADMIN_URL + 'student/export_student_history_csv_data.php');
					//url: ADMIN_URL + 'student/export_student_admin_overviewol_csv_data.php',
                    $.ajax({
                        url: ADMIN_URL + 'student/export_student_admin_overviewol_csv_data_license.php',
                        type: "post",
                        method:"POST",
                        data:{ ids : records_to_export },
                        success: function(data) {
			...
			$('#select_admin_all_students').on('click', function(e) {
			...
			$('.chkbox').on('click', function(e) {
				...
				$('#select_admin_all_students').prop(
					'checked',
