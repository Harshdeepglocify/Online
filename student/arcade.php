...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                                        ...
                                        <div class="hangman_msg">
                                            ...
                                            <div class="box-body ">
                                                    ...
                                                    <table class="table table-bordered hangman-table" id="hangman-table">
                                                        <thead>
                                                            <tr> 
                                                                ...
                                                                <th style="width: 350px !important;">Hangman Lesson Title</th>
                                                                <th style="width: 40px  !important;">Edit</th>
                                                                <th style="width: 43px  !important;">Delete</th>
                                                            </tr> 
                                                        </thead>
                                                        <tbody>
                                                            <?php
												...
												<div class="new-option-section">
                                                    <button type="button" style="" class="dashboard-settings-btn btn-block" data-toggle="modal" data-target="#add-hangman-modal" >Create New</button>
                                                    <button class="new-option-btn" aria-label="Create hangman lesson more options">
                                                ...
                                                <div class="new-option-section-wrap" style="display:none;">
                                                        <ul class="new-option">
                                                           ...
                                                           <!-- <li>
                                                                <button type="button" class="dashboard-settings-btn btn-block" data-toggle="modal" data-target="#typio-import-csv_modal">Import from CSV</button>
                                                            </li> -->
                                                        </ul>
                                                </div>
                                            </div>
        ...
        $(document).ready(function() {
            var typio_table = $('#hangman-table').DataTable({
                   "processing": true,
                   "serverSide": true,
                   "ajax": {
                       "url": "<?php echo ADMIN_URL; ?>config/config-student.php",
                       "type": "POST",
                       data: {'action': 'ajax_arcade_lesson','is_arcade_ajax' : '1'},
                   },
                   "order": [[1, 'DESC']],
                   "columnDefs": [
