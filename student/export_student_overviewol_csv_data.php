<?php
	include "../config/config.php";
		...
		if ($request_hash[0] == $report_hash) {
			...
			echo json_encode([
					"Success" => "200",
					"msg" => "<h4><b>" .$display_name . "</b> is already included in a <b>Activity</b> report today. Please check the <a href='" . ADMIN_URL . "student/student-reports.php' class='history_hide' id='list_lnk_mystu'>Students Reports</a> page.</h4>"
				]);
		} else {
			// Insert new request
			...
			if ($query_result) {
				echo json_encode([
					"Success" => "200",
					"msg" => "<h4>Generating <b>Activity</b> report. Please check the <a href='".ADMIN_URL."student/student-reports.php' class='history_hide' id='list_lnk_mystu' >Students Reports</a> page to access your report.</h4>"
				]);
			} else {
				echo json_encode([
					"Success" => "500",
