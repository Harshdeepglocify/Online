                                        ...
                                        <div class="">
                                            ...
                                            <div class="box-body students_decks_tbl">
												...
												<div class="new-option-section">
                                                    <button type="button" style="margin-top:15px;" class="dashboard-settings-btn btn-block" data-toggle="modal" data-target="#deck-maker-modal" aria-label="create new deck">Create New Deck</button>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="box-body students_test_tbl">
												...
												<div class="new-option-section">
                                                    <button type="button" style="margin-top:15px;" class="dashboard-settings-btn btn-block" data-toggle="modal" data-target="#add-students-test-modal" aria-label="create new test">Create New Test</button>
                        ...
                        <div class="modal-footer" style="margin-top: 20px">
                            ...
                            <div class=" edit-desk-cls" style="padding-right:0px;display:inline-block;width:100%;">
                                <div class="new-option-section">
                                                        ...
                                                        <button class="new-option-btn" id="new-option-btn-edit-deck" aria-label="more options">
                                                            <i class="fa fa-chevron-down"></i>
                                                        </button>
                                    </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="col-md-12 test-cls">
                                <div class="new-option-section">
                                                    ...
                                                    <button class="new-option-btn" id="new-option-btn-edit-test" aria-label="more options">
                                                        <i class="fa fa-chevron-down"></i>
                                                    </button>
                                </div>
