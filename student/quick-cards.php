...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="wrapper">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="box-body students_decks_tbl">
                                                ...
                                                <!--<button type="button" style='margin-bottom:5px;' class="dashboard-settings-btn btn-block create_new_deck" data-toggle="modal" data-target="#deck-maker-modal" aria-label="create new deck">Create New Deck</button>
                                                <button type="button"  class="dashboard-settings-btn btn-block deck-import-modal " data-toggle="modal" data-target="#deck-import-modal" aria-label="import share code">Import Deck from Share Code</button>-->
												<div class="new-option-section">
                                                    <button type="button" style="" class="dashboard-settings-btn btn-block" data-toggle="modal" data-target="#deck-maker-modal" aria-label="create new deck">Create New Deck</button>
                                                    <button class="new-option-btn" id="new-option-btn" aria-label="Create deck more options">
                                                ...
                                                <div class="new-option-section-wrap" style="display:none;" id="new-option-section-wrap">
                                                        <ul class="new-option">
                                                            <li>
                                                                <button type="button"  class="dashboard-settings-btn btn-block deck-import-modal " data-toggle="modal" data-target="#deck-import-modal" aria-label="import deck from share code">Import Deck from Share Code</button>
                                                            </li>                               
                                                            <li>
                                                                <button type="button" class="dashboard-settings-btn btn-block deck-csv-import-modal" data-toggle="modal" data-target="#typio-import-csv_modal" onclick="set_focus_file_type();" aria-label="import deck from csv">Import from CSV</button>
                                                            </li>
                                                        </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="box-body">
                                                ...
                                                <form role="form">
                                                    ...
                                                    <div class="form-group action-btn-chart-init">
                                                        ...
                                                        <button type="button" class="dashboard-settings-btn btn-block quick-card-deck-share-submit" aria-label="share">Share</button>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="table-responsive">                
                                                ...
                                                <!--<button type="button" class="dashboard-settings-btn btn-block create_new_deck" data-toggle="modal" data-target="#add-students-test-modal" aria-label="create new test">Create New Test</button>-->
												<div class="new-option-section">
                                                    <button type="button" style="" class="dashboard-settings-btn btn-block" data-toggle="modal" data-target="#add-students-test-modal" aria-label="create new test">Create New Test</button>
                                                    <button class="new-option-btn" id="new-option-btn-test" aria-label="Create test more options">
                                                        <i class="fa fa-chevron-down"></i>
                                                    </button>
                                                </div>
                                                <div class="new-option-section-wrap" style="display:none;" id="new-option-section-wrap-test">
                                                        <ul class="new-option">
                                                           <li>
                                                                <button type="button" class="dashboard-settings-btn btn-block deck-test-import-modal " data-toggle="modal" data-target="#deck-test-import-modal" aria-label="Import test from share code">Import Test from Share Code</button>
                                                            </li>                               
                                                          <!--  <li>
                                                                <button type="button" class="dashboard-settings-btn btn-block deck-csv-import-modal-test" data-toggle="modal" data-target="#typio-import-csv_modal-test" aria-label="import test from CSV">Import Test from CSV</button>
                                                            </li>-->
                                                        </ul>
                                                </div>	
                                            ...
                                            <div class="box-body">
                                                ...
                                                <form role="form">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <!-- <label>Students</label> -->
                                                        <div class="table-responsive">
                                                        <table class="table table-bordered" id="share-table1">
                                                            <thead>
                                                                <tr>
                                                                    <th>Students</th>
                                                                </tr>       
                                                    ...
                                                    <div class="form-group action-btn-chart-init">
                                                        ...
                                                        <button type="button" class="dashboard-settings-btn btn-block quick-card-test-share-submit" aria-label="share test">Share</button>
			...
			<!-- start : add quickcard csv import model-->
            ...
            <div class="modal fade" id="typio-import-csv_modal" aria-hidden="false" style="display: none;">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <div class="col-md-12">
                                <button type="button" class="dashboard-settings-btn btn-block" name="import_csv_typio" id="import_csv_typio" aria-label="import deck from csv">Import Deck</button>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
             <!-- end: add quickcard csv import model-->

             <!-- start : add quickcard csv import model-->

            <div class="modal fade" id="typio-import-csv_modal-test" aria-hidden="false" style="display: none;">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST" name="add-typio-csv-import-form-test" id="add-typio-csv-import-form-test" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>CSV File</label>
                                     <input type="file" class="form-control" name="typio_file_upload_test" id="typio_file_upload_test">
                        ...
                        <div class="modal-footer">
                            <div class="col-md-12">
                                <button type="button" class="dashboard-settings-btn btn-block" name="import_csv_typio_test" id="import_csv_typio_test" aria-label="import test">Import Test</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST" id="add-students-deck-form">
                                ...
                                <!-- <button type="button" class="btn btn-primary" id="reset_data" aria-label="reset">Reset</button> -->
                        ...
                        <div class="modal-footer">
                            ...
                            <!-- <div class="col-md-6" > <!-- style="margin-bottom: 10px"
                               ...
                               <button type="button" class="btn btn-primary pull-right" id="add-more-side_fields" aria-label="add card to deck">Add Card to Deck</button>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    ...
                                    <button type="button" class="dashboard-settings-btn btn-block" id="add-more-side_fields" aria-label="add card to deck"> Add Card to Deck</button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="col-md-12">
                                    ...
                                    <button type="button" class="dashboard-settings-btn btn-block add-student-import-deck-btn" name="add-students" aria-label="Import deck">Import Deck</button>
                        ...
                        <div class="modal-footer" style="margin-top: 20px">
                            ...
                            <div class="col-md-12 edit-desk-cls" style="padding-right:0px;display:inline-block;width:100%;">
								<div class='export-div col-md-8 col-sm-8'>
									...
									<!--<button type="button" class="dashboard-settings-btn btn-block deck-export-modal" aria-label="export deck to share code">Export Deck to Share Code</button>-->
                            ...
                            <div class=" edit-desk-cls" style="padding-right:0px;display:inline-block;width:100%;">
                                <div class="new-option-section">
                                                        <button type="button" class="dashboard-settings-btn btn-block edit-modal-save" aria-label="save changes">Save changes</button>
                                    ...
                                    <div class="new-option-section-wrap" style="display:none;" id="new-option-section-wrap-edit-deck">
                                                            <ul class="new-option">
                                                                <li>
                                                                   <button type="button" class="dashboard-settings-btn btn-block deck-export-modal" aria-label="export deck">Export Deck to Share Code</button>
                                                                </li>                               
                                                            </ul>
                                        </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="col-md-12" style="margin-bottom: 10px">
                                ...
                                <div class="form-group add-more-one-line-wrap" style="margin-top: 15px;float: right">
                                    ...
                                    <button type="button" class="dashboard-settings-btn btn-block add-more-question" id="add-more-question" aria-label="add question to test">Add Question to Test</button>

                                    <p id="error_add_que_to_test" class="error"></p>

                                    <!--       <button type="button"   class="btn btn-success" id="reset_test_data" aria-label="reset">Reset</button> -->
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="col-md-12 test-cls">
								<div class='export-test-div col-md-8 col-sm-8'>
									...
									<!--<button type="button" class="dashboard-settings-btn btn-block deck-test-export-modal " aria-label="export deck to share code">Export Deck to Share Code</button> -->
                            ...
                            <div class="col-md-12 test-cls">
                                <div class="new-option-section">
                                                    ...
                                                    <button class="new-option-btn" id="new-option-btn-edit-test" aria-label="Save test more options">
                                                        <i class="fa fa-chevron-down"></i>
                                                    </button>
                                </div>
                                <div class="new-option-section-wrap" style="display:none;" id="new-option-section-wrap-edit-test">
                                                        <ul class="new-option">
                                                            <li>
                                                               <button type="button" class="dashboard-settings-btn btn-block deck-test-export-modal " aria-label="export test">Export Test to Share Code</button>
                                                            </li>                               
                                                        </ul>
                                   </div>
                            </div>
        ...
        <script>
            ...
            $(document).ready(function() {
               ...
               var typio_table = $('#students_decks_tbl').DataTable({
                   "processing": true,
                   "serverSide": true,
                   "ajax": {
                       "url": "<?php echo ADMIN_URL; ?>config/config-student.php",
                       "type": "POST",
                       data: {'action': 'ajax_quick_card_lesson','is_ajax_card' : '1'},
                   },
                   "order": [[1, 'DESC']],
                   "columnDefs": [
            ...
            $(document).ready(function() {
               ...
               var typio_table = $('#students_test_tbl').DataTable({
                   "processing": true,
                   "serverSide": true,
                   "ajax": {
                       "url": "<?php echo ADMIN_URL; ?>config/config-student.php",
                       "type": "POST",
                       data: {'action': 'ajax_quick_card_test_tbl_lesson','is_ajax_test_card' : '1'},
                   },
                   "order": [[1, 'DESC']],
                   "columnDefs": [
                       {"targets": 0, "name": "id", 'searchable': false, 'orderable': false},
            ...
            $(document).ready(function() {
            var typio_table = $('#share-tableold').DataTable({
                   "order": [[0, 'DESC']],
                   "columnDefs": [
            ...
            $(document).ready(function() {
            var typio_table = $('#share-table1old').DataTable({
                   "order": [[0, 'DESC']],
                   "columnDefs": [
                       {"targets": 0, "name": "id", 'searchable': true, 'orderable': true},
                   ]
