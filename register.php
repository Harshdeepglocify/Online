...
if (isset($_POST) && !empty($_POST)) {
    ...
    if (isset($_POST['Submit']) && $_POST['Submit'] == 'Register') {
        ...
        if (empty($email)) {
            $error = 1;
            $_SESSION['error']['message'] = 'Email can not be blank';
            $_SESSION['error']['color'] = 'danger';
        }
        if(empty($_POST['g-recaptcha-response'])){
            $error = 1;
            $_SESSION['error']['message'] = 'Please g-recaptcha can not leave empty';
            $_SESSION['error']['color'] = 'danger';   
        }
...
<html>
    <head>
        ...
        <style>
            ...
            #registartion{display: none;font-family:poppins;font-size:22px;}
            <?php
        ...
        <div class="login-box  ">          
            ...
            <div class="login-box-body theme-page">
                ...
                <div class="register_header">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-xs-12 form-group input_box no-padding">
                            <a class="btn btn-primary btn-block btn-flat btn-accessibyte" href="javascript:void(0)" id="user_type_student" type="button" aria-label="Home User Registration Button" style="margin-top 6px; margin-bottom: 6px;">Home User</a>
                            <!-- <p>Individual user access without the need for School Edition.</p> -->
                        </div>

                        <div class="col-xs-12 form-group input_box no-padding">

                            <a class="btn btn-primary btn-block btn-flat btn-accessibyte" id="user_type_teacher" href="javascript:void(0)" type="button" aria-label="School Edition Registration Button" style="margin-top 6px; margin-bottom: 6px;">Accessibyte School Edition</a>
                            <!-- <p>This is where you create your Teacher Dashboard and manage students.</p>  -->                           
                        </div>

                        <div class="col-xs-12 form-group input_box no-padding">
                            <a class="btn btn-primary btn-block btn-flat btn-accessibyte" href="<?php echo LICENSE_UPDATE_FILE_PATH; ?>" type="button" aria-label="Update existing license Button" style="margin-top 6px; margin-bottom: 6px;">Update Existing License</a>
                 ...
                 <div class="row" id="top_row">
                    <div class="col-xs-12">
                        <div class="pull-left register-center" style="margin-top: 24px; margin-bottom: 24px;">
                ...
                <div class="register_header">
                    <div class="col-xs-12">
                        ...
                        <div class="pull-left">
                            ...
                            <div class="pull-left" style="margin-bottom: 80px;">
                                <ul>
                                    <li style="margin-top: 12px;" ><a href="https://www.accessibyte.com/knowledge-base/registration-setup/im-a-teacher-how-do-i-get-started-using-accessibyte-online/" class="accessibyte-link2">I'm a teacher. How do I get started using Accessibyte Online?</a></li>
                                    <li style="margin-top: 12px;" ><a href="https://www.accessibyte.com/knowledge-base/registration-setup/i-just-need-individual-access-to-typio-no-teacher-stuff/" class="accessibyte-link2">I need individual access to Accessibyte Online. No teacher stuff.</a></li>
                                    <li style="margin-top: 12px;" ><a href="https://www.accessibyte.com/knowledge-base/registration-setup/how-do-i-renew-access-to-accessibyte-online/" class="accessibyte-link2">How do I upgrade my trial or renew access to Accessibyte Online?</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <form action="<?php echo ADMIN_URL . 'register.php' ?>" method="POST" id="registartion" class="margin-bottom">
                   ...
                   <span class='checkednote error help-block' id="edd_license-error"></span>
  <div class="form-group" style="margin-left: 19%;">
                    ...
                    <div class="row">
                        <div class="col-xs-12 text-center">
							...
							<div class="registerCheck form-group">
								...
								<label for="agree" style="display: unset;"> I agree to Accessibyte's <a href="<?php echo WP_URL; ?>terms" target="_blank" class="accessibyte-link"> terms and privacy </a>
								</label>
							</div>
                    ...
                    <div class="form-group">
                        <input type="submit" value="Register" name="Submit" class="btn btn-primary col-md-12" onclick="$(this).closest('form').submit()" style="margin-bottom: 70px;"/>
                    </div>
                </form>
  ...
  <div class="row" id="bottom_row" style="display:none">
                    <div class="col-xs-12">
