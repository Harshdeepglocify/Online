...
function updateAppTypioSettingData($update_typio_setting_data = '') {
    ...
    $update_typio_setting_ready_data = array(
        ...
        126 => $update_typio_setting_data['typio_sfx'], 127 => $update_typio_setting_data['typio_highlight'], 131 => $update_typio_setting_data['typio_accuracy_goal'], 
        ...
        121 => $update_typio_setting_data['typio_voice_rate'], 122 => $update_typio_setting_data['typio_voice_pitch'],
    ...
    $student_id ='';
    if ($update_typio_setting_data['TypioSettingSubmit']  == 'Save Typio Settings For All Settings') {
