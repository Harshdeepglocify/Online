        ...
        if(!empty($teacher_code)){
            ...
            if(!empty($data)){
                ...
                if(!empty($flag)){
                    ...
                    register_user('student', base64_encode($_firstname), base64_encode($_lastname), base64_encode($_username), base64_encode($_email), $_password, base64_encode($_organization), $license, 0, 0, $teacher_code, false,0,$teachername);
                
                    $result['status'] = TRUE;
                    $result['msg'] = 'Student Add successfully. <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a></h4>';
                } else {
                    $result['status'] = TRUE;
