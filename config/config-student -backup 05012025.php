...
function displayAppBrailDataTableAverageBarChart($student_id = 0, $Brail_start_date = 0, $Brail_end_date = 0) {
    ...
    $log_Brail_data_html .= '<tr><td>' . $log_data_table_combo_title . '</td><td>' . (!empty($combo_data) ? floor(($combo_data / $log_Brail_data_count)) : '0' ) . '</td></tr>';
...
$update_typio_setting_data['typio_voice_pitch1'] = 'High';
   ...
   161 => $update_typio_setting_data['typio_font_size'], 115 => $update_typio_setting_data['typio_font_size']
    );
    /* START : SET FOR ALL STUDENT ADDED BY PHP DEV 6 ON 03-09-2021 */
    $student_id ='';
