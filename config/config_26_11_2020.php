...
function AddUserDefault_ExtaSettings($user_id) {
    ...
    $query = query("INSERT INTO settings (id, item, variable) VALUES 
                            ...
                            ( '" . $user_id . "', '16', '12, 18, 22' ),
                            ( '" . $user_id . "', '116', '12, 18, 22' ),
                            ( '" . $user_id . "', '216', '12, 18, 22' ),
                            ( '" . $user_id . "', '316', '12, 18, 22' ),
                            ( '" . $user_id . "', '416', '12, 18, 22' ),
...
function getapplogforweekTable_all($userid, $startdate, $enddate) {
    ...
    //$startdate = '2017-01-01';
    global $con;
   $data = "SELECT * FROM log WHERE log.id ='" . $userid . "' AND log.date >= '" . $startdate . "' AND log.date <= '" . $enddate . "' AND (app ='Typio-OL' || app ='PP-OL' || app ='Quick-Cards-OL' || app ='Arcade-OL') ORDER BY date DESC";
    ...
    while ($row = mysqli_fetch_assoc($data_rows)) {
        ...
        else if($row['app'] == "PP-OL"){
            $class="Propack";
        }
        else if($row['app'] == "Quick-Cards-OL"){
            $class="Quick-Cards-OL";
        }
        else if($row['app'] == "Arcade-OL"){
            $class="Arcade-OL";
        }
 ...
 * @return boolean
 */
function update_no_license_data_new($license_key, $no_of_student) {
