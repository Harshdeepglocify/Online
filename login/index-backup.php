...
<!--            <div style="font-family: Roboto Slab, serif; background-color: #000; font-size: 20px; color: #FFFFFF" class="alert  alert-dismissable fade in">
        ...
        <div class="login-box">
            ...
            <div class="login-box-body login-header">
                <span class="logo-lg">
                    <div class="image">
                        <img src="<?php echo ADMIN_URL . 'img/accessibyte logo.svg' ?>" class="accessibyte-logo center-block img-responsive" alt="Accessibyte Online logo">
                    </div>
                </span>
            </div>
...
<div class="main-footer footer ">
 <div class='col-md-12'><span style='align-items: center;'><strong style='margin-right:25px;'><a href=' https://www.accessibyte.com/terms-privacy/' target='_blank' style='font-size: medium;
    color: black;'><u>Privacy Policy</u></a></strong><strong><a href=' https://www.accessibyte.com/terms-privacy/' target='_blank' style='font-size: medium;
    color: black;' ><u>Acknowlegements</u></a></strong></span></div>
<div class='col-md-12' style="margin-top:10px"><p>&copy;2022 Accessibyte, LLC. Typio<sup>tm</sup> is a trademark of Accessibyte, LLC.</p></div>
</div>
    </body>
</html>
