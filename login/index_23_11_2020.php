                ...
                <form action="<?php echo ADMIN_URL . 'login/Robot.php' ?>" method="post" id="login-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xs-12">
                            <button type="submit" name="Sign In" aria-label="Log in button" class="btn btn-primary btn-block btn-flat"/>Log In<i class="fa fa-long-arrow-right" aria-hidden="true"></i> </button>                      
