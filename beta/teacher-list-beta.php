                                ...
                                if (!empty($no_of_licence) && isset($no_of_licence['no_teacher_use'])) {
                                    ...
                                    if(!$is_expired){
                                        ...
                                        <div class="new-option-section-wrap" style="display: none;">
                                            <ul class="new-option">
                                                <li> <a href="javascript:;" class="teacher-import-csv" >Import Teacher List CSV</a></li>
                                                <li> <a href="javascript:;" class="teacher-export-to-csv" >Export Teacher List CSV</a></li>
                                                <li><a href="<?php echo ADMIN_URL . "teacher/export_teacher_data_pdf.php";?>" class="teacher-export-to-pdf" >Export Teacher List PDF</a></li>
                                            </ul>
                                        </div>
                                        <?php
                                    }
